<template>
  <v-container class="pa-0 d-flex flex-column align-center justify-center text-center" fluid>
    ...
    <div v-if="upperContentType !== 'none'" class="mb-1 w-100 d-flex justify-center">
      ...
      <WordGroupCard
        v-else-if="upperContentType === 'wordGroupCard' && upperWordList"
        :wordList="upperWordList!"
      />
    </div>
    ...
    <div v-if="middleContentType !== 'none'" class="mb-1 w-100 d-flex justify-center">
      ...
      <WordGroupCard
        v-else-if="middleContentType === 'wordGroupCard' && middleWordList"
        :wordList="middleWordList!"
      />
    </div>
    ...
    <div v-if="lowerContentType !== 'none'" class="w-100 d-flex justify-center">
      ...
      <WordGroupCard
        v-else-if="lowerContentType === 'wordGroupCard' && lowerWordList"
...
const upperLabelProps = computed<LabelSettings | undefined>(
  () => props.wordGroup.contents?.upper?.labelSettings,
)
const upperWordList = computed<WordItem[] | undefined>(
  () => props.wordGroup.contents?.upper?.wordList,
)

const lowerContentType = computed(() => props.wordGroup.contents?.lower?.contentType)
const lowerLabelProps = computed<LabelSettings | undefined>(
  () => props.wordGroup.contents?.lower?.labelSettings,
)
const lowerWordList = computed<WordItem[] | undefined>(
  () => props.wordGroup.contents?.lower?.wordList,
)

const middleContentType = computed(() => props.wordGroup.contents?.middle?.contentType)
const middleLabelProps = computed<LabelSettings | undefined>(
  () => props.wordGroup.contents?.middle?.labelSettings,
)
const middleWordList = computed<WordItem[] | undefined>(
  () => props.wordGroup.contents?.middle?.wordList,
)
</script>
